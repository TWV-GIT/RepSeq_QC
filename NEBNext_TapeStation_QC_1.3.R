...
win_dir <- 'C:\\Users\\tverdonckt\\OneDrive - ITG\\Desktop\\DenMark_VLAIO\\Data\\TapeStation\\2024-06-27'
#win_dir <- 'C:\\Users\\wolf\\OneDrive - ITG\\Desktop\\DenMark_VLAIO\\Data\\TapeStation'
run_id <- "205_208 - 2024-06-27 - 14-55-33-HSD1000"
...
# define functions -------------------------------------------------------------
save_plots <- function(){
  pdf(file = paste0(run_id, "_library_size_plot.PDF"), width = 8, height = 6)
...
XML_file <- paste0(run_id, '.xml')
CSV_file <- paste0(run_id, '\\', run_id, '_Electropherogram.csv')
